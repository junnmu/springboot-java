...
import com.jun.spring.entities.*;
import com.jun.spring.entities.enums.OrderStatus;
import com.jun.spring.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2020-12-07T19:53:07Z"), OrderStatus.PAID, u1);
        ...
        // Associando o pedido 1 com o pagamento 1 e depois salvando o pedido novamente
        // Não preciso de um Repository para uma entidade dependente
        Payment pay1 = new Payment(null, Instant.parse("2020-12-07T21:53:07Z"), o1);
        o1.setPayment(pay1);
